...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-hidden min-h-[500px] sm:min-h-[650px] bg-gray-200 flex justify-center text-center dark:bg-gray-500 duration-200 -z-[999]">
      {/* background pattern */}
                ...
                <div className="order-1 sm:order-1">
                  <div className="relative z-10">
                    <img
                      src={womenwear}
                      alt=""
                      className="w-[300px] h-[300px] sm:h-[550px] sm:w-[550px] sm:scale-125 object-contain mx-auto"
                    />
                  </div>
                </div>
              </div>

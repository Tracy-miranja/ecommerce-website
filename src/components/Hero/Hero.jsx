...
const Hero = () => {
  return (
    <div className="relative overflow-hidden min-h-[500px] sm:min-h-[650px] bg-gray-200 flex justify-center text-center dark:bg-gray-500 duration-200">
      {/* background pattern */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            <div className="order-2 sm:order-1">
              <img
                src={womenwear}
                alt=""
                className="w-[300px] h-[30px] sm:h-[450px] sm:w-[450px] sm:scale-125 object-contain mx-auto"
              />
            </div>
          </div>
        </div>
